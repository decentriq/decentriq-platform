...
DECENTRIQ_API_PLATFORM_HOST = os.getenv("DECENTRIQ_API_PLATFORM_HOST", "api.decentriq.com")
DECENTRIQ_API_PLATFORM_PORT = int(os.getenv("DECENTRIQ_API_PLATFORM_PORT", "443"))
DECENTRIQ_API_PLATFORM_USE_TLS = True if os.getenv("DECENTRIQ_API_PLATFORM_USE_TLS", "true") == "true" else False
