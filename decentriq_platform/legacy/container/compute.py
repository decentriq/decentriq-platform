...
class StaticContainerCompute(Node):
    ...
    def __init__(
        ...
        **Parameters**:
        ...
        configuration.static.includeContainerLogsOnError = (
            include_container_logs_on_error
        )
        configuration.static.includeContainerLogsOnSuccess = (
            include_container_logs_on_success
        )
...
from ...decoder import ContainerWorkerDecoder
