...
_FATQUOTE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dcapMrsigner', full_name='attestation.Fatquote.dcapMrsigner', index=4,
...
_ATTESTATIONSPECIFICATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='intelDcapMrsigner', full_name='attestation.AttestationSpecification.intelDcapMrsigner', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ATTESTATIONSPECIFICATIONINTELDCAPMRSIGNER = _descriptor.Descriptor(
  name='AttestationSpecificationIntelDcapMrsigner',
  full_name='attestation.AttestationSpecificationIntelDcapMrsigner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='mrsigner', full_name='attestation.AttestationSpecificationIntelDcapMrsigner.mrsigner', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='isvprodid', full_name='attestation.AttestationSpecificationIntelDcapMrsigner.isvprodid', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dcapRootCaDer', full_name='attestation.AttestationSpecificationIntelDcapMrsigner.dcapRootCaDer', index=2,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=b"",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='accept_debug', full_name='attestation.AttestationSpecificationIntelDcapMrsigner.accept_debug', index=3,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='accept_out_of_date', full_name='attestation.AttestationSpecificationIntelDcapMrsigner.accept_out_of_date', index=4,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='accept_configuration_needed', full_name='attestation.AttestationSpecificationIntelDcapMrsigner.accept_configuration_needed', index=5,
      number=5, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='accept_revoked', full_name='attestation.AttestationSpecificationIntelDcapMrsigner.accept_revoked', index=6,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FATQUOTE.fields_by_name['dcapMrsigner'].message_type = _FATQUOTEDCAP
...
_FATQUOTE.oneofs_by_name['fatquote'].fields.append(
  _FATQUOTE.fields_by_name['dcapMrsigner'])
_FATQUOTE.fields_by_name['dcapMrsigner'].containing_oneof = _FATQUOTE.oneofs_by_name['fatquote']
...
_ATTESTATIONSPECIFICATION.fields_by_name['intelDcapMrsigner'].message_type = _ATTESTATIONSPECIFICATIONINTELDCAPMRSIGNER
...
_ATTESTATIONSPECIFICATION.oneofs_by_name['attestation_specification'].fields.append(
  _ATTESTATIONSPECIFICATION.fields_by_name['intelDcapMrsigner'])
_ATTESTATIONSPECIFICATION.fields_by_name['intelDcapMrsigner'].containing_oneof = _ATTESTATIONSPECIFICATION.oneofs_by_name['attestation_specification']
...
DESCRIPTOR.message_types_by_name['AttestationSpecificationIntelDcapMrsigner'] = _ATTESTATIONSPECIFICATIONINTELDCAPMRSIGNER
