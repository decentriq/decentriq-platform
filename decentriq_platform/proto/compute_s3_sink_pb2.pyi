...
class S3SinkWorkerConfiguration(google.protobuf.message.Message):
    ...
    """Optional content type for the S3 object"""
    @property
    ...
    def HasField(self, field_name: typing.Literal["_contentType", b"_contentType", "contentType", b"contentType", "credentials", b"credentials", "dqDspCredentials", b"dqDspCredentials", "userDefinedCredentials", b"userDefinedCredentials"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_contentType", b"_contentType", "contentType", b"contentType", "credentials", b"credentials", "dqDspCredentials", b"dqDspCredentials", "endpoint", b"endpoint", "objects", b"objects", "region", b"region", "s3Provider", b"s3Provider", "userDefinedCredentials", b"userDefinedCredentials"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_contentType", b"_contentType"]) -> typing.Literal["contentType"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["credentials", b"credentials"]) -> typing.Literal["userDefinedCredentials", "dqDspCredentials"] | None: ...
...
class UserDefinedCredentials(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["userDefinedCredentials", b"userDefinedCredentials"]) -> None: ...
...
class DqDspCredentials(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dspType", b"dspType"]) -> None: ...
...
class S3Object(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["format", b"format", "raw", b"raw", "zip", b"zip"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["dependency", b"dependency", "format", b"format", "raw", b"raw", "zip", b"zip"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["format", b"format"]) -> typing.Literal["zip", "raw"] | None: ...
...
class ZipObject(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["fullContent", b"fullContent", "kind", b"kind", "singleFile", b"singleFile"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["fullContent", b"fullContent", "kind", b"kind", "singleFile", b"singleFile"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["kind", b"kind"]) -> typing.Literal["singleFile", "fullContent"] | None: ...
...
class S3Credentials(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["accessKey", b"accessKey", "secretKey", b"secretKey"]) -> None: ...
