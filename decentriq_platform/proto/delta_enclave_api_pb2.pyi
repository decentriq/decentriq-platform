...
class Request(google.protobuf.message.Message):
    ...
    DELTAREQUESTV2_FIELD_NUMBER: builtins.int
    @property
    def deltaRequest(self) -> global___DataNoncePubkey: ...
    @property
    def extensionMessage(self) -> global___ExtensionMessage: ...
    @property
    def deltaRequestV2(self) -> global___DataNoncePubkey: ...
    def __init__(
        self,
        *,
        deltaRequest: global___DataNoncePubkey | None = ...,
        extensionMessage: global___ExtensionMessage | None = ...,
        deltaRequestV2: global___DataNoncePubkey | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["deltaRequest", b"deltaRequest", "deltaRequestV2", b"deltaRequestV2", "extensionMessage", b"extensionMessage", "request", b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["deltaRequest", b"deltaRequest", "deltaRequestV2", b"deltaRequestV2", "extensionMessage", b"extensionMessage", "request", b"request"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["request", b"request"]) -> typing_extensions.Literal["deltaRequest", "extensionMessage", "deltaRequestV2"] | None: ...
