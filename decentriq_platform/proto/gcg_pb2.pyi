...
class UpdateDataRoomStatusRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"dataRoomId",b"dataRoomId",u"status",b"status"]) -> None: ...
...
class RemovePublishedDatasetRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"dataRoomId",b"dataRoomId",u"leafName",b"leafName"]) -> None: ...
