...
class SqlQueryResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"data",b"data",u"jobId",b"jobId",u"sql_query_response",b"sql_query_response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"data",b"data",u"jobId",b"jobId",u"sql_query_response",b"sql_query_response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"sql_query_response",b"sql_query_response"]) -> typing_extensions.Literal["data","jobId"]: ...
